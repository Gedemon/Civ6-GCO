...
INSERT OR REPLACE INTO Tags(Tag, Vocabulary) VALUES ('CLASS_BARBARIAN_RANGED', 'ABILITY_CLASS');
...
UPDATE BarbarianTribes 			SET RangedTag ='CLASS_BARBARIAN_RANGED' 		WHERE TribeType ='TRIBE_MELEE';
...
UPDATE BarbarianAttackForces	SET SpawnRate = 1, NumMeleeUnits = 0, NumRangeUnits = 0;
UPDATE BarbarianTribeNames		SET NumMilitary = 0;
--*/

INSERT OR REPLACE INTO TypeTags(Type, Tag) VALUES ('UNIT_HEAVY_CHARIOT', 'CLASS_BARBARIAN_CAVALRY');
INSERT OR REPLACE INTO TypeTags(Type, Tag) VALUES ('UNIT_SLINGER', 'CLASS_BARBARIAN_RANGED');
INSERT OR REPLACE INTO TypeTags(Type, Tag) VALUES ('UNIT_SLINGER_SCOUT', 'CLASS_BARBARIAN_SKIRMISHER');
INSERT OR REPLACE INTO TypeTags(Type, Tag) VALUES ('UNIT_PELTAST', 'CLASS_BARBARIAN_SKIRMISHER');
INSERT OR REPLACE INTO TypeTags(Type, Tag) VALUES ('UNIT_WARRIOR', 'CLASS_BARBARIAN_MELEE');
INSERT OR REPLACE INTO TypeTags(Type, Tag) VALUES ('UNIT_SPEARMAN', 'CLASS_BARBARIAN_MELEE');
...
(	'BUILDING_CENTRAL_SQUARE_ANCIENT',		'GCO_REDUCE_CITY_RANGED_STRIKE'	),
(	'BUILDING_CENTRAL_SQUARE_CLASSICAL',	'GCO_REDUCE_CITY_RANGED_STRIKE'	),
(	'BUILDING_CENTRAL_SQUARE_MEDIEVAL',		'GCO_REDUCE_CITY_RANGED_STRIKE'	),
(	'BUILDING_CENTRAL_SQUARE_RENAISSANCE',	'GCO_REDUCE_CITY_RANGED_STRIKE'	),
(	'BUILDING_CENTRAL_SQUARE_INDUSTRIAL',	'GCO_REDUCE_CITY_RANGED_STRIKE'	),
(	'BUILDING_CENTRAL_SQUARE_MODERN',		'GCO_REDUCE_CITY_RANGED_STRIKE'	),
(	'BUILDING_CENTRAL_SQUARE_ARMS_RACE',	'GCO_REDUCE_CITY_RANGED_STRIKE'	),
(	'BUILDING_CENTRAL_SQUARE_ATOMIC',		'GCO_REDUCE_CITY_RANGED_STRIKE'	),
(	'BUILDING_CENTRAL_SQUARE_INFORMATION',	'GCO_REDUCE_CITY_RANGED_STRIKE'	),
(	'BUILDING_CENTRAL_SQUARE_FUTURE',		'GCO_REDUCE_CITY_RANGED_STRIKE'	);
/*
