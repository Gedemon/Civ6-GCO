...
INSERT OR REPLACE INTO GlobalParameters (Name, Value) VALUES ('COMBAT_ATTACKER_MATERIEL_KILL_PERCENT',	85);	-- Percentage of the opponent's materiel gained when killing it
...
-- Administration
INSERT OR REPLACE INTO GlobalParameters (Name, Value) VALUES ('MIN_ADMIN_SUPPORT_PERCENT',				25);
