...
CREATE TABLE IF NOT EXISTS UnitsToRemove (
		UnitType TEXT NOT NULL
);

INSERT OR REPLACE INTO UnitsToRemove (UnitType)
	VALUES 
...
DELETE FROM Units WHERE UnitType IN (SELECT UnitsToRemove.UnitType from UnitsToRemove);