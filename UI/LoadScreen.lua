...
-- GCO <<<<<
function InitializeGCO()
	Controls.LoadingMovie:SetMovieFinishedCallback( ChangeMovie )
end
Events.LoadScreenContentReady.Add( InitializeGCO )

local MovieList = {"Time.bk2", "Time.bk2", "Time.bk2", "TUT_OUTRO.bk2", "Culture.bk2"} -- loop will use mostly the "Time victory" movie, most fitting, others are here for variety -- "TUT_INTRO.bk2" "Domination.bk2" "Science.bk2" "Defeat.bk2"
function ChangeMovie()
	movie = MovieList[Automation.GetRandomNumber(#MovieList)+1]
	Controls.LoadingMovie:SetMovie(movie)
end
-- GCO >>>>>
Initialize();