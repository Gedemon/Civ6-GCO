...
ExposedMembers.PlotIterator_Initialized = false

function Initialize()
	if not ExposedMembers.GCO then ExposedMembers.GCO = {} end
		
	-- Plot Iterators
	ExposedMembers.GCO.PlotRingIterator 		= PlotRingIterator
	ExposedMembers.GCO.PlotAreaSpiralIterator 	= PlotAreaSpiralIterator
	ExposedMembers.GCO.PlotAreaSweepIterator 	= PlotAreaSweepIterator
	ExposedMembers.PlotIterator_Initialized		= true
end
Initialize()
